...
## 📱 Aplicaciones Móviles (PWA/APK)

| Aplicación | Descripción | Tecnologías |
|------------|-------------|-------------|
| 📊 **Mi Dieta Tracker** | <div align="justify">Progressive Web App (PWA) para seguimiento personal de dieta, peso, pasos diarios y períodos de ayuno intermitente. Incluye sistema de cálculo automático de ayuno, estadísticas semanales y mensuales con gráficos interactivos, gestión de comidas (desayuno, almuerzo, cena, snacks) y modo offline completo mediante Service Worker.</div><br/><br/>**✨ Características:**<br/><br/>• 📈 Seguimiento diario de peso, pasos y comidas<br/>• ⏱️ Cálculo automático de horas de ayuno entre comidas<br/>• 📊 Gráficos interactivos con Chart.js<br/>• 💾 Almacenamiento local (LocalStorage)<br/>• 🔄 Funciona 100% offline con Service Worker<br/>• 📱 Instalable como app nativa en Android<br/>• 🎨 Interfaz responsive y moderna<br/><br/>🌐 **Web App:** **Web App:** <br/>https://merry-pixie-79628f.netlify.app/dieta_tracker_pwa.html<br/>📥 **Versión:** v4.3 \| **APK disponible:** <br/https://merry-pixie-79628f.netlify.app/ para instalación en Android | `HTML5`, `CSS3`, `JavaScript`, `PWA`, `Service Worker`, `Chart.js`, `LocalStorage`, `Netlify`, `PWABuilder`, `Android APK` |
